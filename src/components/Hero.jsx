...
const Hero = () => {
  ...
  // 🚀 Function jo link par click karte hi "Clothes and wear" par le jaye
  const handleExploreClick = () => {
    navigate('/category?type=clothes-and-wear');
  };

  return (
    <div className="w-full bg-white border border-gray-200 rounded-[2rem] overflow-hidden shadow-sm flex flex-row min-h-[480px]">
      ...
      {/* 2. Main Banner Area */}
      <div className="flex-1 flex flex-row bg-white relative">
        
        {/* Left Content - Shifted towards Categories */}
        <div className="w-[48%] pl-10 pr-4 py-12 flex flex-col justify-center z-10">
          
          {/* Top Actions: Live Tag and Linked Explore Link */}
          <div className="flex items-center gap-6 mb-8">
             ...
             {/* 🔗 Linked to Clothes and Wear */}
             <button 
                onClick={handleExploreClick}
                className="text-[11px] font-black uppercase tracking-[0.2em] text-[#1e293b] hover:text-[#b89146] flex items-center gap-2 transition-all group border-b-2 border-transparent hover:border-[#b89146]"
             >
                Explore Collection 
          ...
          <h1 className="text-5xl md:text-7xl font-black text-[#1e293b] leading-[0.9] mb-6 tracking-tighter">
            Discover Your <br/> 
            <span className="text-[#b89146]">Essentials</span>
          </h1>
          
          <p className="text-gray-500 text-[15px] leading-relaxed font-bold max-w-[320px]">
            Curated premium collections. Sourced globally, delivered locally.
          </p>
        </div>

        {/* Right Image - Crystal Clear */}
        <div className="w-[52%] relative overflow-hidden">
          ...
          />
          <div className="absolute inset-y-0 left-0 w-px bg-gray-100"></div>
        </div>
      </div>

      {/* 3. Right Side - Prominent & Uniform Boxes */}
      <div className="hidden xl:flex flex-col w-[270px] bg-[#f8fafc] shrink-0 border-l-2 border-gray-100 p-5 gap-4">
         
         {/* Box 1: Global Shipping */}
         <div className="bg-white p-6 rounded-[1.5rem] border-2 border-transparent shadow-sm flex flex-col gap-4 group hover:border-[#b89146] transition-all cursor-default">
            <div className="w-12 h-12 bg-[#1e293b] text-white rounded-2xl flex items-center justify-center text-2xl shadow-lg shadow-gray-200">🚀</div>
            <div>
         ...
         <div className="bg-white p-6 rounded-[1.5rem] border-2 border-transparent shadow-sm flex flex-col gap-4 group hover:border-[#b89146] transition-all cursor-default">
            <div className="w-12 h-12 bg-[#1e293b] text-white rounded-2xl flex items-center justify-center text-2xl shadow-lg shadow-gray-200">🛡️</div>
            <div>
         ...
         {/* Box 3: Weekly Promo */}
         <div className="flex-1 bg-gradient-to-br from-[#b89146] to-[#8a6d35] p-6 rounded-[1.5rem] flex flex-col justify-center text-white relative overflow-hidden shadow-xl shadow-orange-100/50 group">
            ...
            <div className="mt-4 bg-white/20 w-fit px-3 py-1 rounded-lg text-[10px] font-black group-hover:bg-white group-hover:text-[#b89146] transition-all">
               Claim Now
            </div>
